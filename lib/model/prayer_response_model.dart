...
class PrayerResponseModel {
  ...
  PrayerResponseModel.fromJson(Map<String, dynamic> json) {
    code = json['code'];
    status = json['status'];
...
class Hijri with Formattable {
  ...
  Hijri.fromJson(Map<String, dynamic> json) {
    ...
    if (json['adjustedHolidays'] != null) {
      adjustedHolidays = json['adjustedHolidays'].cast<Null>();
    }
    method = json['method'];
  }
...
class Gregorian with Formattable {
  String? date;
  String? format;
  @override
  String? day;
